...
# -----------------------------------------------------------------------------
text=("Incrematal Dental Dataset. - https://pandoradata.earth/dataset/amalthea-a-database-of-isotopic-measurements-on-archaeological-and-forensic-tooth-dentine-increments ")
...
Figure1 = pd.read_csv("Incremental_DentalClean_Data.csv", sep=";")
...
# --- TABLE 3 ---
# Print caption:
print("Table 1: This table shows the descriptive statistics of the dataset. It shows",
      "the count, unique, top and frequency of the dataset. The nominal values",
      "are shown as 'x' to make it complete")
...
#reading the database
Table1 = pd.read_csv("Incremental_DentalClean_Data.csv", sep=";")

#Printen the complete table
print("Dental Incremental Dataset:")
print(Table1.head())


#Printing the Descriptive statistics of the table. The nominal values are 
#writing in the table as "x"

print("Table Descriptive statistics of the Dental Incremental Dataset")
Table=Table1.describe(include="all")
